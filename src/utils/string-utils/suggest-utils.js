...
export const valueToSuggestions = (value: string, choices: Array<string>): Array<string> => {
...
export const valuesToSuggestions = (values: Array<string>, choices: Array<string>): Array<string> => {
