...
describe("getAccessors", () => {
  it("gets accessors", () => {
    expect(getAccessors(columns as any)).toEqual([
      "abc",
      "123",
...
describe("toDelimitedReport", () => {
  ...
  it("generates a delimited string", () => {
    expectWithEnter(toDelimitedReport(columns as any, data)).toEqual(
  ...
  it("adds empty column when missing an accessor", () => {
    const delimitedString = toDelimitedReport([...columns, {}] as any, data);
  ...
  it("test different delimiter", () => {
    ...
    expectWithEnter(toDelimitedReport(columns as any, data, option)).toEqual(
